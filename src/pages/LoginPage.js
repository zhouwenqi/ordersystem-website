        ...
        return (
            <div className="login-layout-container">
                    ...
                    <div className="login-layout-top">
                        <div className="login-layout-top-header">
                            <a href="/">
                                ...
                                <span className="login-layout-top-title">Antd Design</span>
                            </a>                            
                        </div>
                        <div className="login-layout-top-desc">Ant Design 是西湖区最具影响力的 Web 设计规范</div>
                    </div>                    
                ...
                <footer className="login-layout-footer">
                    <div className="ogin-layout-footer-copyrigyt">Copyright &copy; 2018 蚂蚁金服科技</div>
                </footer>                 
            </div>
        );
    }
